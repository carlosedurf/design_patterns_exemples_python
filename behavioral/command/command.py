...
class LighChangeColor(ICommand):
    """Comando concreto"""
...
if __name__ == "__main__":
    ...
    bedroom_light_on = LighOnCommand(bedroom_light)
    bathroom_light_on = LighOnCommand(bathroom_light)
    bedrrom_light_blue = LighChangeColor(bedroom_light, "Blue")
    bedrrom_light_red = LighChangeColor(bedroom_light, "Blue")

    remote = RemoteController()

    remote.button_add_command("first_button", bedroom_light_on)
    remote.button_add_command("second_button", bathroom_light_on)
    remote.button_add_command("third_button", bedrrom_light_blue)
    remote.button_add_command("fourth_button", bedrrom_light_red)
